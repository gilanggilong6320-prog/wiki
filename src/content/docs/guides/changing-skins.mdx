...
You can update a single account the skin shown in the launcher through the Accounts tab in the launcher by selecting
your account from the dropdown and then right clicking the skin and clicking the "Update Skin" item:
